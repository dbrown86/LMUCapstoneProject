...
def extract_bert_embeddings():
    ...
    try:
        ...
        contact_reports_df = pd.read_csv('data/synthetic_donor_dataset/contact_reports.csv')
        ...
        if os.path.exists('models/best_contact_classifier.pt'):
            print("Loading trained model weights...")
            state_dict = torch.load('models/best_contact_classifier.pt', map_location=device)
        ...
        # Save embeddings
        np.save('data/bert_embeddings_real.npy', bert_embeddings)
...
def extract_gnn_embeddings():
    ...
    try:
        ...
        print("\nLoading data...")
        donors_df = pd.read_csv('data/synthetic_donor_dataset/donors.csv')
        relationships_df = pd.read_csv('data/synthetic_donor_dataset/relationships.csv')
        ...
        # Save embeddings
        np.save('data/gnn_embeddings_real.npy', gnn_embeddings)
